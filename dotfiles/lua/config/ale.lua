...
function M.setup()
    ...
    '-jar ' .. vim.fn.expand('~/checkstyle.jar') .. ' -c ' .. vim.fn.expand('~/.config/checkstyle/checkstyle_no_indent.xml')
    ...
    'check --dir %:h --rulesets category/java/bestpractices.xml --format text --include-pattern "^%:t$"'
